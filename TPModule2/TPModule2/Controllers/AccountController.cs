...
namespace TPModule2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            model.CaptchaQuestion = captcha.Item1;
            model.GoodAnswer = captcha.Item2;
            return View(model);
        }

        private Tuple<string, string> GenerateCaptcha()
        {
            Random rdm = new Random();
            switch (rdm.Next(3))
            {
                case 0: return new Tuple<string, string>("Un - 1 =", "0");

                case 1: return new Tuple<string, string>("Deux - 1 =", "1");

                default:
                    return new Tuple<string, string>("Trois - 1 =", "2");
            }
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            ModelState.AddModelError("", "Le nom d'utilisateur, le mot de passe fourni ou le captcha est incorrect.");
        ...
        public ActionResult AddRoleToUser(string rolename)
        {
            ...
            return Content(string.Format("Rôle '{0}' ajouté à l'utilisateur '{1}''.", rolename, User.Identity.Name));
        }
        ...
        public ActionResult AddRoleToUser(string userName, string roleName)
        {
            ...
            return Content(string.Format("Rôle '{0}' ajouté à l'utilisateur '{1}''.", roleName, userName));
        }
